...
{
    class CommentGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/commentgenerator";

        /// <summary>
        /// Make a GET request to the Comment Generator API
        /// </summary>
        static async Task<JsonDocument> CallCommentGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;mode&quot;] &#x3D; &quot;text&quot;, [&quot;tone&quot;] &#x3D; &quot;positive&quot;, [&quot;emojis&quot;] &#x3D; true };
        ...
        {
            Console.WriteLine("📤 Calling Comment Generator API...\n");

            var result = await CallCommentGeneratorAPI();
