...
class commentgeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/commentgenerator');
        }
        ...
        this.validationRules = {"mode":{"type":"string","required":true},"tone":{"type":"string","required":false,"default":"positive"},"count":{"type":"integer","required":false,"min":1,"max":10,"default":1},"emojis":{"type":"boolean","required":false,"default":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/commentgenerator`);
        }
    }
...
module.exports = commentgeneratorWrapper;
