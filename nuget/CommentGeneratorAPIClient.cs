...
namespace APIVerve.API.CommentGenerator
{
    ...
    /// <summary>
    /// Client for the CommentGenerator API
    /// </summary>
    public class CommentGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/commentgenerator";
        ...
        {
            { "mode", new ValidationRule { Type = "string", Required = true } },
            { "tone", new ValidationRule { Type = "string", Required = false } },
            { "count", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 10 } },
            { "emojis", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public CommentGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CommentGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CommentGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CommentGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CommentGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(CommentGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CommentGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CommentGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CommentGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CommentGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CommentGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CommentGeneratorQueryOptions options)
        {
