...
```gradle
dependencies {
    implementation 'com.github.apiverve:commentgenerator-api:1.1.13'
}
```
...
```java
import com.apiverve.commentgenerator.CommentGeneratorAPIClient;
import com.apiverve.commentgenerator.APIResponse;
import com.apiverve.commentgenerator.APIException;

// Initialize the client
CommentGeneratorAPIClient client = new CommentGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("mode", "text");
    parameters.put("tone", "positive");
    parameters.put("count", 1);
    parameters.put("emojis", true);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/commentgenerator](https://docs.apiverve.com/ref/commentgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/commentgenerator](https://docs.apiverve.com/ref/commentgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/commentgenerator-api/issues)
