// Package commentgenerator provides a Go client for the Comment Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/commentgenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Comment Generator API.
//
// Parameters:
//   - mode (required): string - The mode of comment generation
//   - tone: string - The tone of the comments
//   - count: integer - The number of comments to generate (max 10) [min: 1, max: 10]
//   - emojis: boolean - Whether to include emojis in the comments
type Request struct {
	Mode string `json:"mode"` // Required
	Tone string `json:"tone,omitempty"` // Optional
	Count int `json:"count,omitempty"` // Optional
	Emojis bool `json:"emojis,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"emojis": {Type: "boolean", Required: false},
	}
...
// ResponseData contains the data returned by the Comment Generator API.
