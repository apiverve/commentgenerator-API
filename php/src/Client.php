...
namespace APIVerve\Commentgenerator;
...
/**
 * Client for the Comment Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/commentgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/commentgenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CommentgeneratorClient] {$message}\n";
        }
    }
}
